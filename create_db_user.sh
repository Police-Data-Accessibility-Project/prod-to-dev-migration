...
psql -d $ADMIN_DB_CONN_STRING -c "GRANT EXECUTE ON ALL PROCEDURES IN SCHEMA public TO $DEV_DB_USER;"
psql -d $ADMIN_DB_CONN_STRING -c "ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT EXECUTE ON PROCEDURES TO $DEV_DB_USER;"
