...
-- Convert `last_approval_editor` to json column
ALTER TABLE DATA_SOURCES
ADD COLUMN LAST_APPROVAL_EDITOR_NEW JSON;

UPDATE DATA_SOURCES
SET LAST_APPROVAL_EDITOR_NEW = LAST_APPROVAL_EDITOR::JSON;

ALTER TABLE DATA_SOURCES
DROP COLUMN LAST_APPROVAL_EDITOR;

ALTER TABLE DATA_SOURCES
RENAME COLUMN LAST_APPROVAL_EDITOR_NEW TO LAST_APPROVAL_EDITOR;
